...
const articles: Record<string, {
  ...
  "file-form-5472-missed-prior-years": {
    ...
    body: [
      ...
      `FileTax.co offers past-year filing for $${PRICE_PER_YEAR} per year, with an optional CPA-prepared reasonable cause letter for a single $${PRICE_RCL} fee that covers every year you're catching up on. A single missed year with the letter totals $${PRICE_PER_YEAR + PRICE_RCL}; three missed years totals $${3 * PRICE_PER_YEAR + PRICE_RCL}, because the letter is never charged per year. This is available for one or more missed years directly through the platform. See our pricing page for full details.`,
    ],
    ctaLink: "/past-filings",
    ctaLabel: "Fix a Missed Year",
  },
