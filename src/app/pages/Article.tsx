...
const articles: Record<string, {
  ...
  "file-form-5472-missed-prior-years": {
    ...
    body: [
      ...
      "FileTax.co offers past-year filing for $150 per year, with an optional CPA-prepared reasonable cause letter for a single $200 fee that covers every year you're catching up on. A single missed year with the letter totals $350. This is available for one or more missed years directly through the platform. See our pricing page for full details.",
    ],
    ctaLink: "/past-filings",
    ctaLabel: "Fix a Missed Year",
  },
